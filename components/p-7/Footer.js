...
const Footer = () => {
  ...
  return (
    <footer className="pt-8 md:pt-14 border-t-2 border-gray-100 rounded-lg bg-white">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-0 lg:grid-cols-5  md:px-20 py-4 px-8">
      ...
      <div className="md:px-40 px-8 md:py-8 py-4 md:flex items-center md:justify-between justify-center bg-gray-200 text-gray-600  space-y-3 md:space-y-0">
        <div className="md:flex items-center md:space-x-8 space-y-3 md:space-y-0">
          ...
          <p>
            © {new Date().getFullYear().toString()} SmartContract Chainlink Ltd
            SEZC.
          </p>
        </div>
